 ...
 * make sure UDID consistency after app delete and reinstall
 */
+ (NSString*)_UDID_iOS7
{
...
extern "C" {
    ...
    // Get UDID
    const char* GetIOSDeviceUDID() {
        const char* udid = nil;
        
        UDIDTools *udidTools = [[UDIDTools alloc] init];
        udid = __MakeStringCopy([udidTools UDID]);
